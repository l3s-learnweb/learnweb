...
nanoscroller-v0.8.7 - used to create a nice scroller on resources list/etc.
responsive-calendar-v1.0.0 - used to show archive timeline
...
js/jquery.dropdown.min.js - never imported
js/tipped.js - never imported
