    ...
    $(this).on('click', function () {
        ...
        if (nextElement.hasClass('open')) {
            ...
            if ($(this).attr('id') === 'added_res_tab_new_changes') {
                var currentIndex = nextElement.find('.slick-current').attr('data-slick-index');
            ...
            if (nextElement.height() === 0) {
                nextElement.height(nextElement.find('div:first-child').outerHeight(true));
            }
        }
    })
});
...
$('#show_activities').on('click', function () {
