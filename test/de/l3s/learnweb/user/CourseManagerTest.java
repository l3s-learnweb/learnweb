...
class CourseManagerTest
{
    ...
    CourseManager courseManager = new CourseManager(learnweb);
    ...
    {
        ArrayList<String> expected = new ArrayList<>(Arrays.asList("LogCanvasBrasilia", "LogCanvasCairo", "LogCanvasBerlin", "LogCanvasBeijing", "LogCanvasBrisbane", "LogCanvasTag 1"));
