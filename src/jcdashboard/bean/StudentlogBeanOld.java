...
@ManagedBean
@ViewScoped
public class StudentlogBeanOld extends ApplicationBean implements Serializable
{
    private static final long serialVersionUID = 3461152818600391381L;
    private static final Logger log = Logger.getLogger(StudentlogBeanOld.class);
