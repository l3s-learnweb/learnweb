...
public class SolrEdgeComputeForEachSession
{
    public final static Logger log = Logger.getLogger(SolrEdgeComputeForEachSession.class);
    ...
    public SolrEdgeComputeForEachSession()
    {
        wikipediaSolrUrl = Learnweb.getInstance().getProperties().getProperty("WIKIPEDIA_SOLR_URL");
        //wikipediaSolrUrl = "http://learnweb.l3s.uni-hannover.de:8900/solr/wikipediaCollection";
    ...
    private List<Entry<EntityPair, Double>> sortByScore(Map<EntityPair, Double> m)
    {
    ...
    public void main(String args[])
    {
        ...
        try
        {
            ...
            solrEdgeComputator.insertEdgesForSessionId("");
            System.exit(0);
        }
