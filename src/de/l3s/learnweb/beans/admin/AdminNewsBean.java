...
public class AdminNewsBean extends ApplicationBean implements Serializable
{
    ...
    private boolean isCanSend() // TODO this should obsolt. These checks are done through JSF validators. The @NotEmpty annotation should already solve this task. Otherwise you can use the "required" attribute of the input form
    {
        if(getTitle() == null)
        {
