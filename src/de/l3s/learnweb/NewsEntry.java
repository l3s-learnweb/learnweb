...
//	private boolean isQueryNeeded;
	...
	public NewsEntry(LogEntry news, User user, Resource resource,
			Integer comments, Integer tags, String text, Boolean resourceAction, Date date) {
		super();
		this.news = news;
		this.user = user;
...
//		this.datedifference=null;
	...
	public String getDatedifference() {
       ...
       //TODO PrettyTime p= new PrettyTime();
