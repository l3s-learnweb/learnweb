...
public class LanguageItem implements Serializable
{
    ...
    public de.l3s.learnweb.resource.glossary.LanguageItem.LANGUAGE getLanguage()
    {
        return language;
    }

    public void setLanguage(de.l3s.learnweb.resource.glossary.LanguageItem.LANGUAGE language)
    {
