...
public class PasswordBean extends ApplicationBean implements Serializable
{
	...
	private void sendMail(User user) throws AddressException, MessagingException {
		 ...
		 * "kemkes@l3s.de"); props.put("mail.password", "ego4klap8");
		 * 
		 * 
		 * props.put("mail.smtp.auth", "true");
		 * props.put("mail.smtp.starttls.enable", "true");
		...
		Session session1 = Session.getDefaultInstance(props,
				new GMailAuthenticator("interweb9@googlemail.com", "QDsG}GM5"));
		...
		message.setText("Hi "+ user.getUsername() +",\nif you want to change the password of your learnweb account click here:\n"+ link);
		message.saveChanges();
