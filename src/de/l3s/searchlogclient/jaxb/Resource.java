...
public class Resource
{
    ...
    public Resource(int resourceId, String url, String type, String source, String filename, String shortdescrp, int thumbnail_height, int thumbnail_width, String thumbnail_url, int thumbnail4_height, int thumbnail4_width, String thumbnail4_url, int resultsetId,
            int resource_rank)
    {
